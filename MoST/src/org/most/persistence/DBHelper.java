...
import org.most.pipeline.PipelineJSON;
...
import org.most.pipeline.PipelineScan;
import org.most.pipeline.PipelineSystemStats;
import org.most.pipeline.PipelineWifiPing;
...
public class DBHelper extends SQLiteOpenHelper {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		createTable(db, PipelineWifiPing.TBL_WIFI_PING, PipelineWifiPing.CREATE_WIFI_PING_TABLE);
		createTable(db, PipelineScan.TBL_SCAN, PipelineScan.CREATE_SCAN_TABLE);
		createTable(db, PipelineJSON.TBL_JSON, PipelineJSON.CREATE_JSON_TABLE);
	}
