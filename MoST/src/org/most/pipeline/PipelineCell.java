...
public class PipelineCell extends Pipeline {
	...
	public static final String KEY_GSM_RSSI = "PipelineClee.rssi";
	...
	public static final String FLD_RSSI = "rssi";
	...
	public static final String CREATE_CELL_TABLE = String.format(
			"_ID INTEGER PRIMARY KEY, %s INT NOT NULL, %s INT NOT NULL, %s TEXT NOT NULL, %s INT NOT NULL, %s INT NOT NULL, %s INT NOT NULL, %s INT NOT NULL, %s INT NOT NULL, %s INT NOT NULL, %s INT NOT NULL",
			FLD_TIMESTAMP, FLD_RSSI, FLD_PHONE_TYPE, FLD_GSM_CELL_ID, FLD_GSM_LAC, FLD_BASE_STATION_ID, FLD_BASE_STATION_LATITUDE, FLD_BASE_STATION_LONGITUDE, FLD_BASE_NETWORK_ID, FLD_BASE_SYSTEM_ID);
	...
	public void onData(DataBundle b) {
		//TODO DISABLE SAVING & TRANSMISSION OF PRIVATE DATA (AS PER TCD EHTICAL APPLICATION)
		/*
		try {
			...
			if (b.getInt(CellInput.KEY_PHONE_TYPE) == TelephonyManager.PHONE_TYPE_GSM) {
				...
				rssi = b.getInt(CellInput.KEY_RSSI);
			}
