...
import org.most.monitoring.BluetoothMonitor;
...
public class BluetoothScanInput extends PeriodicInput {
	...
	//TODO BLE Scan Period
	public final static int PREF_DEFAULT_BLUETOOTH_SCANPERIOD_MS = 5000; //60000 * 30;
	...
	public BluetoothScanInput(MoSTApplication context) {
		...
		monitor = new BluetoothMonitor(context);
	}
	...
	class BluetoothDeviceReceiver extends BroadcastReceiver {
		...
		public void onReceive(Context context, Intent intent) {
			...
			if (BluetoothDevice.ACTION_FOUND.equals(action)) {
				...
				post(b);
				monitor.addHost(b.getString(BluetoothScanInput.KEY_MAC));
			}
		}
	}
